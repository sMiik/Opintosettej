...
\begin{figure}[hb]
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\caption{T-mallin osaamisalueet ICT-palveluyritykselle.}
		\label{fig:Tareas}
	\end{subfigure}
	\begin{subfigure}[b]{0.5\textwidth}
